...
const UserSlice = createSlice({
  ...
  reducers: {
    ...
    addBudget(state, action) {
      ...
      state.currentUser!.budget[action.payload.month][action.payload.cat] =
        action.payload.budget;
    },
    deleteBudget(state, action) {
      delete state.currentUser!.budget[action.payload.month][
        action.payload.cat
      ];
    },
    ...
    addExpenseCategory(state, action: PayloadAction<string>) {
      state.currentUser!.expenseCategory = [
        ...state.currentUser!.expenseCategory,
        action.payload,
      ];
    },
    ...
    setIncome(state, action) {
      ...
      state.currentUser!.income[action.payload.month][action.payload.category] =
    ...
    setExpense(state, action) {
      ...
      state.currentUser!.spend[action.payload.month][action.payload.category] =
        action.payload.amount;
    },
