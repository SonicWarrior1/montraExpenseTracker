...
export const STRINGS = {
    ...
    SureRemoveBudgetNo: 'Are you sure do you wanna remove this budget?',
    No: 'No',
    Yes: 'Yes',
    BudgetDeletedSuccesfully: 'Budget Deleted Succesfully',
    RemovethisTransaction: 'Remove this Transaction?',
    sureRemoveTransaction: 'Are you sure do you wanna remove this transaction?',
    ...
    LimitExceeded: "You've exceed the limit!",
